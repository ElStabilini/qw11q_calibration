...
# Single QUA script generated at 2025-01-16 16:16:54.103924
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("7681436383121303763", "B4/drive")
        wait(11, "B4/acquisition")
        measure("4985763208615452000", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("4985763208615452000_B4|acquisition_I")
        r2.buffer(5000).save("4985763208615452000_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "4985763208615452000": "4985763208615452000_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7681436383121303763": "7681436383121303763",
            },
        },
    },
    "pulses": {
        "4985763208615452000_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-8785204331130607606_i",
                "Q": "-8785204331130607606_q",
            },
            "digital_marker": "ON",
        ...
        "7681436383121303763": {
            "length": 40,
            "waveforms": {
                "I": "7681436383121303763_i",
                "Q": "7681436383121303763_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-8785204331130607606_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-8785204331130607606_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "7681436383121303763_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_7ae",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_7ae": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_042": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
