...
# Single QUA script generated at 2024-12-10 09:26:23.419179
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.1259493670886076,(v4<2.002594936708861),(v4+0.025189873417721526)):
            align()
            play("-2687827630313700248"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("-8742098687076664565", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(75).average().save("-8742098687076664565_D1|acquisition_I")
        r2.buffer(75).average().save("-8742098687076664565_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312810106.0191784,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-8742098687076664565": "-8742098687076664565_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "5886791973025605554": "5886791973025605554",
                "-2687827630313700248": "-2687827630313700248",
            },
        },
    },
    "pulses": {
        "-8742098687076664565_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3431435261597639343_i",
                "Q": "3431435261597639343_q",
            },
            "digital_marker": "ON",
        ...
        "5886791973025605554": {
            "length": 40,
            "waveforms": {
                "I": "5886791973025605554_i",
                "Q": "5886791973025605554_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-2687827630313700248": {
            "length": 40,
            "waveforms": {
                "I": "-2687827630313700248_i",
                "Q": "-2687827630313700248_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "3431435261597639343_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "3431435261597639343_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "5886791973025605554_i": {
        ...
        "5886791973025605554_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "-2687827630313700248_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_6b8",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_6b8": [{'intermediate_frequency': -312810106.0191784, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_88f": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
