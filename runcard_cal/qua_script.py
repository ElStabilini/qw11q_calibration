...
# Single QUA script generated at 2024-11-22 07:53:41.951194
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.0,(v4<2.000050505050505),(v4+0.0201010101010101)):
            with for_(v5,-241729925,(v5<=-43729925),(v5+2000000)):
                ...
                align()
                play("2433410668777228112"*amp(v4), "D1/drive")
                wait(11, "D1/acquisition")
                measure("-7285350607378165706", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
                r1 = declare_stream()
                save(v2, r1)
                r2 = declare_stream()
                save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(100).buffer(100).average().save("-7285350607378165706_D1|acquisition_I")
        r2.buffer(100).buffer(100).average().save("-7285350607378165706_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312359963.18604183,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-7285350607378165706": "-7285350607378165706_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "3214607197829303306": "3214607197829303306",
                "2433410668777228112": "2433410668777228112",
            },
        },
    },
    "pulses": {
        "-7285350607378165706_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6797306078185843785_i",
                "Q": "6797306078185843785_q",
            },
            "digital_marker": "ON",
        ...
        "3214607197829303306": {
            "length": 40,
            "waveforms": {
                "I": "3214607197829303306_i",
                "Q": "3214607197829303306_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2433410668777228112": {
            "length": 40,
            "waveforms": {
                "I": "2433410668777228112_i",
                "Q": "2433410668777228112_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "6797306078185843785_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "6797306078185843785_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "3214607197829303306_i": {
        ...
        "3214607197829303306_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "2433410668777228112_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_d24",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_d24": [{'intermediate_frequency': -312359963.18604183, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_80a": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
