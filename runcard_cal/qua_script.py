...
# Single QUA script generated at 2025-04-29 13:46:52.523974
...
with program() as prog:
    ...
    wait((4+(0*(Cast.to_int(v4)+Cast.to_int(v5)))), "B4/acquisition")
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-3647327546501356877", "B2/drive")
        play("8194316484351139403", "B4/drive")
        wait(11, "B2/acquisition")
        wait(11, "B4/acquisition")
        measure("4364427309035407045", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("4364427309035407045", "B4/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
    ...
    with stream_processing():
        r1.buffer(5000).save("4364427309035407045_B2|acquisition_I")
        r2.buffer(5000).save("4364427309035407045_B2|acquisition_Q")
        r3.buffer(5000).save("4364427309035407045_B4|acquisition_I")
        r4.buffer(5000).save("4364427309035407045_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "4364427309035407045": "4364427309035407045_B2/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "intermediate_frequency": 330200527.0,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "4364427309035407045": "4364427309035407045_B4/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-3647327546501356877": "-3647327546501356877",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "8194316484351139403": "8194316484351139403",
            },
        },
    },
    "pulses": {
        "-6717892524436244474_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-5948152531454246713_i",
                "Q": "-5948152531454246713_q",
            },
            "digital_marker": "ON",
        ...
        "8269523536240143543_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-270433479122588050_i",
                "Q": "-270433479122588050_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-3647327546501356877": {
            "length": 40,
            "waveforms": {
                "I": "-3647327546501356877_i",
                "Q": "-3647327546501356877_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8194316484351139403": {
            "length": 40,
            "waveforms": {
                "I": "8194316484351139403_i",
                "Q": "8194316484351139403_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "4364427309035407045_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3683005992844770994_i",
                "Q": "3683005992844770994_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "4364427309035407045_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3683005992844770994_i",
                "Q": "3683005992844770994_q",
    ...
    "waveforms": {
        "-5948152531454246713_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-5948152531454246713_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-270433479122588050_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-270433479122588050_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-3647327546501356877_i": {
        ...
        "3683005992844770994_i": {
            "sample": 0.003624999999999998,
            "type": "constant",
        },
        "3683005992844770994_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_d2c",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_c3f",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_d2c": [{'intermediate_frequency': 9740944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_c3f": [{'intermediate_frequency': 330200527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_d86": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_523": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
