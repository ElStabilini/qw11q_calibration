...
# Single QUA script generated at 2024-11-20 04:48:37.544962
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.39799999999999996,(v4<2.189),(v4+0.39799999999999996)):
            align()
            play("3856018908486544076"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("-5243687654870442390", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5).average().save("-5243687654870442390_D1|acquisition_I")
        r2.buffer(5).average().save("-5243687654870442390_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312363464.9065428,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-5243687654870442390": "-5243687654870442390_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-8366025571948132342": "-8366025571948132342",
                "3856018908486544076": "3856018908486544076",
            },
        },
    },
    "pulses": {
        "-5243687654870442390_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "9168878501669691172_i",
                "Q": "9168878501669691172_q",
            },
            "digital_marker": "ON",
        ...
        "-8366025571948132342": {
            "length": 40,
            "waveforms": {
                "I": "-8366025571948132342_i",
                "Q": "-8366025571948132342_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "3856018908486544076": {
            "length": 40,
            "waveforms": {
                "I": "3856018908486544076_i",
                "Q": "3856018908486544076_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "9168878501669691172_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "9168878501669691172_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-8366025571948132342_i": {
        ...
        "-8366025571948132342_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "3856018908486544076_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_4a1",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_4a1": [{'intermediate_frequency': -312363464.9065428, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_104": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
