...
# Single QUA script generated at 2025-02-08 17:02:16.344313
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("7767924831403133323", "B1/drive")
        play("-3273475351998207497", "B2/drive")
        play("-7437717006057315834", "B3/drive")
        play("8568168678854288783", "B4/drive")
        wait(11, "B4/acquisition")
        wait(11, "B1/acquisition")
        wait(11, "B3/acquisition")
        wait(11, "B2/acquisition")
        measure("8474038504762068286", "B1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("5922894438332478512", "B2/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v4), dual_demod.full("minus_sin", "out1", "cos", "out2", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("8761194787947459451", "B3/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v6), dual_demod.full("minus_sin", "out1", "cos", "out2", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("-8627027700961828802", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v8), dual_demod.full("minus_sin", "out1", "cos", "out2", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("8474038504762068286_B1|acquisition_I")
        r2.buffer(5000).save("8474038504762068286_B1|acquisition_Q")
        r3.buffer(5000).save("5922894438332478512_B2|acquisition_I")
        r4.buffer(5000).save("5922894438332478512_B2|acquisition_Q")
        r5.buffer(5000).save("8761194787947459451_B3|acquisition_I")
        r6.buffer(5000).save("8761194787947459451_B3|acquisition_Q")
        r7.buffer(5000).save("-8627027700961828802_B4|acquisition_I")
        r8.buffer(5000).save("-8627027700961828802_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-8627027700961828802": "-8627027700961828802_B4/acquisition",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "5922894438332478512": "5922894438332478512_B2/acquisition",
            },
        },
        "B1/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "8474038504762068286": "8474038504762068286_B1/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "8761194787947459451": "8761194787947459451_B3/acquisition",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-7437717006057315834": "-7437717006057315834",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7767924831403133323": "7767924831403133323",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-3273475351998207497": "-3273475351998207497",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "8568168678854288783": "8568168678854288783",
            },
        },
    },
    "pulses": {
        "8474038504762068286_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "2502774786179603980_i",
                "Q": "2502774786179603980_q",
            },
            "digital_marker": "ON",
        ...
        "5922894438332478512_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7755994206647338119_i",
                "Q": "-7755994206647338119_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "8761194787947459451_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-6740964492208275509_i",
                "Q": "-6740964492208275509_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-8627027700961828802_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "1507402692728228947_i",
                "Q": "1507402692728228947_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "7767924831403133323": {
            "length": 40,
            "waveforms": {
                "I": "7767924831403133323_i",
                "Q": "7767924831403133323_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-3273475351998207497": {
            "length": 40,
            "waveforms": {
                "I": "-3273475351998207497_i",
                "Q": "-3273475351998207497_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-7437717006057315834": {
            "length": 40,
            "waveforms": {
                "I": "-7437717006057315834_i",
                "Q": "-7437717006057315834_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8568168678854288783": {
            "length": 40,
            "waveforms": {
                "I": "8568168678854288783_i",
                "Q": "8568168678854288783_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "2502774786179603980_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "2502774786179603980_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7755994206647338119_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-7755994206647338119_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-6740964492208275509_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-6740964492208275509_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1507402692728228947_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "1507402692728228947_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "7767924831403133323_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B2/acquisition_mixer_af4",
                "lo_frequency": 7370000000.0,
            },
        },
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B1/acquisition_mixer_3ba",
                "lo_frequency": 7370000000.0,
            },
        },
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B3/acquisition_mixer_8c0",
                "lo_frequency": 7370000000.0,
            },
        },
        "B3/drive": {
    ...
    "mixers": {
        ...
        "B2/acquisition_mixer_af4": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B1/acquisition_mixer_3ba": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B3/acquisition_mixer_8c0": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B3/drive_mixer_e06": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B1/drive_mixer_b4e": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/drive_mixer_d2f": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_674": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
