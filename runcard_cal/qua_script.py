...
# Single QUA script generated at 2025-04-12 19:44:22.911165
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.5632075471698111,(v5<2.0275471698113208),(v5+0.07509433962264156)):
            with for_(v6,9040944,(v6<=10940944),(v6+100000)):
                ...
                align()
                play("1372836820606880645", "B2/drive")
                wait(11, "B2/acquisition")
                measure("-295821280239797961"*amp(v5), "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
                assign(v4, Cast.to_int((((v2*0.6841697267286305)-(v3*0.7293228263451453))>0.002476610362637899)))
                r1 = declare_stream()
                save(v4, r1)
    ...
    with stream_processing():
        r1.buffer(2).buffer(20).buffer(20).buffer(2048).save("-295821280239797961_B2|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-295821280239797961": "-295821280239797961_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1372836820606880645": "1372836820606880645",
            },
        },
    },
    "pulses": {
        "-295821280239797961_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "8754145710405819460_i",
                "Q": "8754145710405819460_q",
            },
            "digital_marker": "ON",
        ...
        "1372836820606880645": {
            "length": 40,
            "waveforms": {
                "I": "1372836820606880645_i",
                "Q": "1372836820606880645_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "8754145710405819460_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "8754145710405819460_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1372836820606880645_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_a5a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_a5a": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_f6b": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
