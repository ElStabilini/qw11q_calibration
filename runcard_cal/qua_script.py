...
# Single QUA script generated at 2024-11-22 13:25:35.427498
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.1259493670886076,(v4<2.002594936708861),(v4+0.025189873417721526)):
            align()
            play("8157776519028904054"*amp(v4), "D1/drive")
            play("8157776519028904054"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("3201855254516182762", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(75).average().save("3201855254516182762_D1|acquisition_I")
        r2.buffer(75).average().save("3201855254516182762_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "3201855254516182762": "3201855254516182762_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "2331683689673416416": "2331683689673416416",
                "8157776519028904054": "8157776519028904054",
            },
        },
    },
    "pulses": {
        "3201855254516182762_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "7822794540373109851_i",
                "Q": "7822794540373109851_q",
            },
            "digital_marker": "ON",
        ...
        "2331683689673416416": {
            "length": 40,
            "waveforms": {
                "I": "2331683689673416416_i",
                "Q": "2331683689673416416_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8157776519028904054": {
            "length": 40,
            "waveforms": {
                "I": "8157776519028904054_i",
                "Q": "8157776519028904054_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "7822794540373109851_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "7822794540373109851_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "2331683689673416416_i": {
        ...
        "2331683689673416416_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "8157776519028904054_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_f16",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_f16": [{'intermediate_frequency': -312360584.50398064, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_531": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
