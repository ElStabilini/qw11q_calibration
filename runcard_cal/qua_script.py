...
# Single QUA script generated at 2025-02-06 07:49:29.506623
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.9919939879759516),(v5+0.003987975951903807)):
            align()
            play("-858916377660103855", "B4/drive")
            wait(11, "B4/flux")
            play("-7073152976904995282"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("-97825748436541986", "B4/drive")
            wait(36, "B4/acquisition")
            measure("7409323723494915771", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*0.9730343180892005)-(v3*-0.2306603906627328))>-0.0004384486988547942)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(500).average().save("7409323723494915771_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "-9002890083301226919": "-9002890083301226919",
                "-7073152976904995282": "-7073152976904995282",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "7409323723494915771": "7409323723494915771_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-858916377660103855": "-858916377660103855",
                "-97825748436541986": "-97825748436541986",
            },
        },
    },
    "pulses": {
        "-858916377660103855": {
            "length": 40,
            "waveforms": {
                "I": "-858916377660103855_i",
                "Q": "-858916377660103855_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-9002890083301226919": {
            "length": 60,
            "waveforms": {
                "single": "-9002890083301226919",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "7409323723494915771_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6258945028342423327_i",
                "Q": "6258945028342423327_q",
            },
            "digital_marker": "ON",
        ...
        "-97825748436541986": {
            "length": 40,
            "waveforms": {
                "I": "-97825748436541986_i",
                "Q": "-97825748436541986_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "6258945028342423327_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "6258945028342423327_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7073152976904995282": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_da8",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_da8": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_c95": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
