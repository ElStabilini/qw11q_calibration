...
# Single QUA script generated at 2025-02-04 14:54:33.346257
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.991328437917223),(v5+0.002656875834445928)):
            align()
            play("-7908460711993352998", "B1/drive")
            wait(11, "B1/flux")
            play("-8561943431691591788"*amp(v5), "B1/flux")
            wait(16, "B1/drive")
            play("4253344702304903662", "B1/drive")
            wait(36, "B1/acquisition")
            measure("-1860591115855815690", "B1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*0.9979139295843761)-(v3*0.06455841650372783))>0.0008879953521066911)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(750).average().save("-1860591115855815690_B1|acquisition_shots")
...
config = {
    ...
    "elements": {
        "B1/flux": {
            ...
            "operations": {
                "-3709772881213387142": "-3709772881213387142",
                "-8561943431691591788": "-8561943431691591788",
            },
        },
        "D1/flux": {
            "singleInput": {
        ...
        "B1/drive": {
            ...
            "operations": {
                "-7908460711993352998": "-7908460711993352998",
                "4253344702304903662": "4253344702304903662",
            },
        },
        "B1/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-1860591115855815690": "-1860591115855815690_B1/acquisition",
            },
        },
    },
    "pulses": {
        "-7908460711993352998": {
            "length": 40,
            "waveforms": {
                "I": "-7908460711993352998_i",
                "Q": "-7908460711993352998_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-3709772881213387142": {
            "length": 60,
            "waveforms": {
                "single": "-3709772881213387142",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-1860591115855815690_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-4239628490791459076_i",
                "Q": "-4239628490791459076_q",
            },
            "digital_marker": "ON",
        ...
        "4253344702304903662": {
            "length": 40,
            "waveforms": {
                "I": "4253344702304903662_i",
                "Q": "4253344702304903662_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "-4239628490791459076_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-4239628490791459076_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-8561943431691591788": {
        ...
        "4253344702304903662_i": {
            "samples": [0.0011180555187915678, 0.0015045081475491685, 0.0019931494632565378, 0.0025995569652476707, 0.0033378972155056613, 0.004219497446825634, 0.005251249417242201, 0.006433965280360931, 0.007760843544895696, 0.009216229744590979, 0.010774864198537374, 0.012401792672522064, 0.01405307218212388, 0.015677334902548905, 0.0172181839630987, 0.018617295840194316, 0.019818008261921365, 0.020769094336384877, 0.021428376161292048] + [0.02176582398456596] * 2 + [0.021428376161292048, 0.020769094336384877, 0.019818008261921365, 0.018617295840194316, 0.0172181839630987, 0.015677334902548905, 0.01405307218212388, 0.012401792672522064, 0.010774864198537374, 0.009216229744590979, 0.007760843544895696, 0.006433965280360931, 0.005251249417242201, 0.004219497446825634, 0.0033378972155056613, 0.0025995569652476707, 0.0019931494632565378, 0.0015045081475491685, 0.0011180555187915678],
            "type": "arbitrary",
        },
        "4253344702304903662_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B1/acquisition_mixer_17e",
                "lo_frequency": 7370000000.0,
            },
        },
    },
    ...
    "mixers": {
        "B1/drive_mixer_d14": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B1/acquisition_mixer_17e": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
