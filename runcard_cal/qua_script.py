...
# Single QUA script generated at 2025-04-30 09:51:27.246022
...
with program() as prog:
    ...
    with for_(v1,0,(v1<100),(v1+1)):
        ...
        play("3974277581962115731", "B2/drive")
        ...
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.75, "B2/drive")
        frame_rotation_2pi(0.125, "B2/drive")
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-1.0, "B2/drive")
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.625, "B2/drive")
        frame_rotation_2pi(0.25, "B2/drive")
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.75, "B2/drive")
        play("3974277581962115731", "B2/drive")
        ...
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.5, "B2/drive")
        frame_rotation_2pi(0.0669439033922408, "B2/drive")
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.5000000000000003, "B2/drive")
        play("3974277581962115731", "B2/drive")
        frame_rotation_2pi(-0.31694390339224077, "B2/drive")
        wait(401, "B2/acquisition")
        measure("313970969905715621", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        assign(v4, Cast.to_int((((v2*0.7359973353402354)-(v3*0.6769844328875466))>0.0024378669440833717)))
        r1 = declare_stream()
        save(v4, r1)
        wait(25000, )
    with stream_processing():
        r1.buffer(100).save("313970969905715621_B2|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/drive": {
            ...
            "operations": {
                "3974277581962115731": "3974277581962115731",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "313970969905715621": "313970969905715621_B2/acquisition",
            },
        },
    },
    "pulses": {
        "3974277581962115731": {
            "length": 40,
            "waveforms": {
                "I": "3974277581962115731_i",
                "Q": "3974277581962115731_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "313970969905715621_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-3561033274836489613_i",
                "Q": "-3561033274836489613_q",
            },
            "digital_marker": "ON",
    ...
    "waveforms": {
        ...
        "-3561033274836489613_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-3561033274836489613_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_47a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/drive_mixer_902": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/acquisition_mixer_47a": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
