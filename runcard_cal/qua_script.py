...
# Single QUA script generated at 2024-11-28 08:09:32.643139
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.1259493670886076,(v4<2.002594936708861),(v4+0.025189873417721526)):
            align()
            play("-8477546114606630916"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("-7981681737156432327", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(75).average().save("-7981681737156432327_D1|acquisition_I")
        r2.buffer(75).average().save("-7981681737156432327_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312367823.11817074,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-7981681737156432327": "-7981681737156432327_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-8633499356695246465": "-8633499356695246465",
                "-8477546114606630916": "-8477546114606630916",
            },
        },
    },
    "pulses": {
        "-7981681737156432327_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "569225030617103301_i",
                "Q": "569225030617103301_q",
            },
            "digital_marker": "ON",
        ...
        "-8633499356695246465": {
            "length": 40,
            "waveforms": {
                "I": "-8633499356695246465_i",
                "Q": "-8633499356695246465_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-8477546114606630916": {
            "length": 40,
            "waveforms": {
                "I": "-8477546114606630916_i",
                "Q": "-8477546114606630916_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "569225030617103301_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "569225030617103301_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-8633499356695246465_i": {
        ...
        "-8633499356695246465_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "-8477546114606630916_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_208",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_208": [{'intermediate_frequency': -312367823.11817074, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_bbb": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
