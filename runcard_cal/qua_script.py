...
# Single QUA script generated at 2025-02-11 13:46:51.186342
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("5356712975287929281", "B1/drive")
        play("6153680466061472252", "B2/drive")
        play("8597815211537031740", "B3/drive")
        play("624112757413573309", "B4/drive")
        wait(11, "B2/acquisition")
        wait(11, "B4/acquisition")
        wait(11, "B3/acquisition")
        wait(11, "B1/acquisition")
        measure("-7338463919842174242", "B1/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("-3428419092502802779", "B2/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("2616889064064803758", "B3/acquisition", None, dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("8055600638868663774", "B4/acquisition", None, dual_demod.full("cos", "sin", v8), dual_demod.full("minus_sin", "cos", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("-7338463919842174242_B1|acquisition_I")
        r2.buffer(5000).save("-7338463919842174242_B1|acquisition_Q")
        r3.buffer(5000).save("-3428419092502802779_B2|acquisition_I")
        r4.buffer(5000).save("-3428419092502802779_B2|acquisition_Q")
        r5.buffer(5000).save("2616889064064803758_B3|acquisition_I")
        r6.buffer(5000).save("2616889064064803758_B3|acquisition_Q")
        r7.buffer(5000).save("8055600638868663774_B4|acquisition_I")
        r8.buffer(5000).save("8055600638868663774_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-3428419092502802779": "-3428419092502802779_B2/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "2616889064064803758": "2616889064064803758_B3/acquisition",
            },
        },
        "B1/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-7338463919842174242": "-7338463919842174242_B1/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "8055600638868663774": "8055600638868663774_B4/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "6153680466061472252": "6153680466061472252",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "8597815211537031740": "8597815211537031740",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "5356712975287929281": "5356712975287929281",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "624112757413573309": "624112757413573309",
            },
        },
    },
    "pulses": {
        "-7338463919842174242_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-6187762295537967849_i",
                "Q": "-6187762295537967849_q",
            },
            "digital_marker": "ON",
        ...
        "-3428419092502802779_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-1017433422444553297_i",
                "Q": "-1017433422444553297_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "2616889064064803758_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7542652458205581721_i",
                "Q": "-7542652458205581721_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "8055600638868663774_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7183134388989342882_i",
                "Q": "-7183134388989342882_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "5356712975287929281": {
            "length": 40,
            "waveforms": {
                "I": "5356712975287929281_i",
                "Q": "5356712975287929281_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "6153680466061472252": {
            "length": 40,
            "waveforms": {
                "I": "6153680466061472252_i",
                "Q": "6153680466061472252_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8597815211537031740": {
            "length": 40,
            "waveforms": {
                "I": "8597815211537031740_i",
                "Q": "8597815211537031740_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "624112757413573309": {
            "length": 40,
            "waveforms": {
                "I": "624112757413573309_i",
                "Q": "624112757413573309_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-6187762295537967849_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-6187762295537967849_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-1017433422444553297_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-1017433422444553297_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7542652458205581721_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-7542652458205581721_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7183134388989342882_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-7183134388989342882_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "5356712975287929281_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_b6a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B3/acquisition_mixer_e04",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B1/acquisition_mixer_d0a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_a01",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_b6a": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/acquisition_mixer_e04": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/acquisition_mixer_d0a": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_a01": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_862": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/drive_mixer_14f": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/drive_mixer_b9d": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_0de": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
