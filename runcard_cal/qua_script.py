...
# Single QUA script generated at 2025-03-24 09:00:40.541975
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-4327052704957800899", "B2/drive")
        wait(11, "B2/acquisition")
        measure("2400119959095733495", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("2400119959095733495_B2|acquisition_I")
        r2.buffer(5000).save("2400119959095733495_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "2400119959095733495": "2400119959095733495_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-4327052704957800899": "-4327052704957800899",
            },
        },
    },
    "pulses": {
        "-2591817391750712282_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-6054105093696978379_i",
                "Q": "-6054105093696978379_q",
            },
            "digital_marker": "ON",
        ...
        "-4327052704957800899": {
            "length": 40,
            "waveforms": {
                "I": "-4327052704957800899_i",
                "Q": "-4327052704957800899_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2400119959095733495_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "890348868062318843_i",
                "Q": "890348868062318843_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
    ...
    "waveforms": {
        "-6054105093696978379_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-6054105093696978379_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-4327052704957800899_i": {
        ...
        "890348868062318843_i": {
            "sample": 0.00175,
            "type": "constant",
        },
        "890348868062318843_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_259",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_259": [{'intermediate_frequency': 9790944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_e34": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
