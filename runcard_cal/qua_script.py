...
# Single QUA script generated at 2025-01-17 18:42:09.424006
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-7642034862823258619", "B4/drive")
        wait(11, "B4/acquisition")
        measure("-1675987075602190074", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("-1675987075602190074_B4|acquisition_I")
        r2.buffer(5000).save("-1675987075602190074_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-1675987075602190074": "-1675987075602190074_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-7642034862823258619": "-7642034862823258619",
            },
        },
    },
    "pulses": {
        "-1675987075602190074_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-2617620951360009366_i",
                "Q": "-2617620951360009366_q",
            },
            "digital_marker": "ON",
        ...
        "-7642034862823258619": {
            "length": 40,
            "waveforms": {
                "I": "-7642034862823258619_i",
                "Q": "-7642034862823258619_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-2617620951360009366_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-2617620951360009366_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7642034862823258619_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_983",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_983": [{'intermediate_frequency': 330298316.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_778": [{'intermediate_frequency': 109678455.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
