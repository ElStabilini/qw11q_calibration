...
# Single QUA script generated at 2025-01-21 06:54:58.152599
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("6124767345747944889", "B2/drive")
        wait(11, "B2/acquisition")
        measure("6516166190640429276", "B2/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("6516166190640429276_B2|acquisition_I")
        r2.buffer(5000).save("6516166190640429276_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "6516166190640429276": "6516166190640429276_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "6124767345747944889": "6124767345747944889",
            },
        },
    },
    "pulses": {
        "6516166190640429276_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-219276562626998651_i",
                "Q": "-219276562626998651_q",
            },
            "digital_marker": "ON",
        ...
        "6124767345747944889": {
            "length": 40,
            "waveforms": {
                "I": "6124767345747944889_i",
                "Q": "6124767345747944889_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-219276562626998651_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-219276562626998651_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "6124767345747944889_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B2/acquisition_mixer_96a",
                "lo_frequency": 7370000000.0,
            },
        },
        "B2/drive": {
    ...
    "mixers": {
        "B2/acquisition_mixer_96a": [{'intermediate_frequency': 10073372.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/drive_mixer_738": [{'intermediate_frequency': 63748730.0, 'lo_frequency': 5900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
