...
# Single QUA script generated at 2025-01-16 16:36:25.967289
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.997158273381295),(v5+0.014316546762589928)):
            align()
            play("-3940700396340308604", "B4/drive")
            wait(11, "B4/flux")
            play("5259108205706216610"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("-3179609767116746735", "B4/drive")
            wait(36, "B4/acquisition")
            measure("4268012843473865131", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*-0.26143754955026)-(v3*-0.9652203933222481))>0.002215054761521925)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(140).average().save("4268012843473865131_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "2630217250458749046": "2630217250458749046",
                "5259108205706216610": "5259108205706216610",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/drive": {
            ...
            "operations": {
                "-3940700396340308604": "-3940700396340308604",
                "-3179609767116746735": "-3179609767116746735",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "4268012843473865131": "4268012843473865131_B4/acquisition",
            },
        },
    },
    "pulses": {
        "-3940700396340308604": {
            "length": 40,
            "waveforms": {
                "I": "-3940700396340308604_i",
                "Q": "-3940700396340308604_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2630217250458749046": {
            "length": 60,
            "waveforms": {
                "single": "2630217250458749046",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "4268012843473865131_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "4814086298560781128_i",
                "Q": "4814086298560781128_q",
            },
            "digital_marker": "ON",
        ...
        "-3179609767116746735": {
            "length": 40,
            "waveforms": {
                "I": "-3179609767116746735_i",
                "Q": "-3179609767116746735_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "4814086298560781128_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "4814086298560781128_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "5259108205706216610": {
            "sample": 0.17462311557788945,
            "type": "constant",
        },
        "-3179609767116746735_i": {
            "samples": [0.0019122312051685873, 0.0025731883433511684, 0.0034089206986104067, 0.004446070758572637, 0.005708867858399413, 0.007216685175589522, 0.008981309812438653, 0.011004130810404815, 0.013273515452095699, 0.01576268961192368, 0.018428451186544403, 0.021211017297298348, 0.024035231438407318, 0.026813238261132712, 0.029448581145735307, 0.031841508282122885, 0.033895109129906946, 0.03552176938051429, 0.036649351381049106] + [0.03722649468648891] * 2 + [0.036649351381049106, 0.03552176938051429, 0.033895109129906946, 0.031841508282122885, 0.029448581145735307, 0.026813238261132712, 0.024035231438407318, 0.021211017297298348, 0.018428451186544403, 0.01576268961192368, 0.013273515452095699, 0.011004130810404815, 0.008981309812438653, 0.007216685175589522, 0.005708867858399413, 0.004446070758572637, 0.0034089206986104067, 0.0025731883433511684, 0.0019122312051685873],
            "type": "arbitrary",
        },
        "-3179609767116746735_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_63f",
                "lo_frequency": 7370000000.0,
            },
        },
    },
    ...
    "mixers": {
        "B4/drive_mixer_1db": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/acquisition_mixer_63f": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
