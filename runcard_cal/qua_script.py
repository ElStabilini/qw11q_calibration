...
# Single QUA script generated at 2025-04-10 17:23:11.820776
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("701025812729735015", "B2/drive")
        wait(11, "B2/acquisition")
        measure("2191117316932748970", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("2191117316932748970_B2|acquisition_I")
        r2.buffer(5000).save("2191117316932748970_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "2191117316932748970": "2191117316932748970_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "701025812729735015": "701025812729735015",
            },
        },
    },
    "pulses": {
        "9120361628185984075_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7472454771692584011_i",
                "Q": "-7472454771692584011_q",
            },
            "digital_marker": "ON",
        ...
        "701025812729735015": {
            "length": 40,
            "waveforms": {
                "I": "701025812729735015_i",
                "Q": "701025812729735015_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2191117316932748970_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "5219537495663839278_i",
                "Q": "5219537495663839278_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
    ...
    "waveforms": {
        "-7472454771692584011_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-7472454771692584011_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "701025812729735015_i": {
        ...
        "5219537495663839278_i": {
            "sample": 0.0015,
            "type": "constant",
        },
        "5219537495663839278_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_294",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_294": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_b55": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
