...
# Single QUA script generated at 2025-03-18 10:54:48.139984
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v4,9540944,(v4<10495517.887989148),Cast.mul_int_by_fixed(v4,1.0104811431657077)):
            update_frequency("B2/acquisition", v4, "Hz", False)
            align()
            play("9155340758993698928", "B2/drive")
            wait(11, "B2/acquisition")
            measure("-5079203722627216140", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(10).buffer(2048).save("-5079203722627216140_B2|acquisition_I")
        r2.buffer(10).buffer(2048).save("-5079203722627216140_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-5079203722627216140": "-5079203722627216140_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "9155340758993698928": "9155340758993698928",
            },
        },
    },
    "pulses": {
        "-5079203722627216140_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-4823312242434405481_i",
                "Q": "-4823312242434405481_q",
            },
            "digital_marker": "ON",
        ...
        "9155340758993698928": {
            "length": 40,
            "waveforms": {
                "I": "9155340758993698928_i",
                "Q": "9155340758993698928_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-4823312242434405481_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-4823312242434405481_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "9155340758993698928_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_41a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_41a": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_5c1": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
