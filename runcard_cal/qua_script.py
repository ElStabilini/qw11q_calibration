...
# Single QUA script generated at 2025-01-20 07:41:26.697162
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-666037888717844999", "B4/drive")
        wait(11, "B4/acquisition")
        measure("8861751029920633821", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("8861751029920633821_B4|acquisition_I")
        r2.buffer(5000).save("8861751029920633821_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "8861751029920633821": "8861751029920633821_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-666037888717844999": "-666037888717844999",
            },
        },
    },
    "pulses": {
        "8861751029920633821_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7958229564539483067_i",
                "Q": "-7958229564539483067_q",
            },
            "digital_marker": "ON",
        ...
        "-666037888717844999": {
            "length": 40,
            "waveforms": {
                "I": "-666037888717844999_i",
                "Q": "-666037888717844999_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-7958229564539483067_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-7958229564539483067_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-666037888717844999_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_292",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_292": [{'intermediate_frequency': 330298316.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_f77": [{'intermediate_frequency': 109678455.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
