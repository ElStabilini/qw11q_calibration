...
# Single QUA script generated at 2025-01-15 08:02:18.778316
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.050379746835443044,(v5<2.002594936708861),(v5+0.02518987341772152)):
            align()
            play("2882904354610622913", "B2/drive")
            wait(11, "B2/flux")
            play("-1073056206600729539"*amp(v5), "B2/flux")
            wait(13, "B2/drive")
            play("3643994983834184782", "B2/drive")
            wait(33, "B2/acquisition")
            measure("-7646041026511657465", "B2/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*0.6205520709401277)-(v3*0.7841652423130719))>0.0026125142084282697)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(78).average().save("-7646041026511657465_B2|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "-399356508773596526": "-399356508773596526",
                "-1073056206600729539": "-1073056206600729539",
            },
        },
        "D2/flux": {
            "singleInput": {
        ...
        "B2/drive": {
            ...
            "operations": {
                "2882904354610622913": "2882904354610622913",
                "3643994983834184782": "3643994983834184782",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-7646041026511657465": "-7646041026511657465_B2/acquisition",
            },
        },
    },
    "pulses": {
        "2882904354610622913": {
            "length": 40,
            "waveforms": {
                "I": "2882904354610622913_i",
                "Q": "2882904354610622913_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-399356508773596526": {
            "length": 52,
            "waveforms": {
                "single": "-399356508773596526",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-7646041026511657465_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6040835597280873018_i",
                "Q": "6040835597280873018_q",
            },
            "digital_marker": "ON",
        ...
        "3643994983834184782": {
            "length": 40,
            "waveforms": {
                "I": "3643994983834184782_i",
                "Q": "3643994983834184782_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "6040835597280873018_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "6040835597280873018_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-1073056206600729539": {
        ...
        "3643994983834184782_i": {
            "samples": [0.0012460382379137248, 0.0016767277202166312, 0.0022213033282811904, 0.0028971257025183664, 0.0037199830373729112, 0.00470249918287307, 0.005852354789839167, 0.007170454978303785, 0.008649219696941287, 0.010271202528091139, 0.012008252339934198, 0.013821413721335572, 0.01566171357752801, 0.017471904059173184, 0.019189132601073893, 0.020748399443086044, 0.022086556238579497, 0.023146512203565634, 0.02388126137262637] + [0.024257336517404967] * 2 + [0.02388126137262637, 0.023146512203565634, 0.022086556238579497, 0.020748399443086044, 0.019189132601073893, 0.017471904059173184, 0.01566171357752801, 0.013821413721335572, 0.012008252339934198, 0.010271202528091139, 0.008649219696941287, 0.007170454978303785, 0.005852354789839167, 0.00470249918287307, 0.0037199830373729112, 0.0028971257025183664, 0.0022213033282811904, 0.0016767277202166312, 0.0012460382379137248],
            "type": "arbitrary",
        },
        "3643994983834184782_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B2/acquisition_mixer_e0d",
                "lo_frequency": 7370000000.0,
            },
        },
    },
    ...
    "mixers": {
        "B2/drive_mixer_d14": [{'intermediate_frequency': 63692382.0, 'lo_frequency': 5900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/acquisition_mixer_e0d": [{'intermediate_frequency': 10073341.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
