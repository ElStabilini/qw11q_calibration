...
# Single QUA script generated at 2024-11-22 06:08:04.825560
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.1259493670886076,(v4<2.002594936708861),(v4+0.025189873417721526)):
            align()
            play("8030212235656071059"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("-1104117134839887319", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(75).average().save("-1104117134839887319_D1|acquisition_I")
        r2.buffer(75).average().save("-1104117134839887319_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312369367.62610054,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-1104117134839887319": "-1104117134839887319_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-4489584140364663452": "-4489584140364663452",
                "8030212235656071059": "8030212235656071059",
            },
        },
    },
    "pulses": {
        "-1104117134839887319_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "8609230913700188795_i",
                "Q": "8609230913700188795_q",
            },
            "digital_marker": "ON",
        ...
        "-4489584140364663452": {
            "length": 40,
            "waveforms": {
                "I": "-4489584140364663452_i",
                "Q": "-4489584140364663452_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8030212235656071059": {
            "length": 40,
            "waveforms": {
                "I": "8030212235656071059_i",
                "Q": "8030212235656071059_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "8609230913700188795_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "8609230913700188795_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-4489584140364663452_i": {
        ...
        "-4489584140364663452_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "8030212235656071059_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_1b2",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_1b2": [{'intermediate_frequency': -312369367.62610054, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_8c8": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
