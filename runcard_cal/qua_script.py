...
# Single QUA script generated at 2025-01-16 16:05:47.728595
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-1333227426234972112", "B4/drive")
        wait(11, "B4/acquisition")
        measure("6436550794298695830", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("6436550794298695830_B4|acquisition_I")
        r2.buffer(5000).save("6436550794298695830_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "6436550794298695830": "6436550794298695830_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-1333227426234972112": "-1333227426234972112",
            },
        },
    },
    "pulses": {
        "6436550794298695830_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6163971096898059051_i",
                "Q": "6163971096898059051_q",
            },
            "digital_marker": "ON",
        ...
        "-1333227426234972112": {
            "length": 40,
            "waveforms": {
                "I": "-1333227426234972112_i",
                "Q": "-1333227426234972112_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "6163971096898059051_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "6163971096898059051_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-1333227426234972112_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_932",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_932": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_5fd": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
