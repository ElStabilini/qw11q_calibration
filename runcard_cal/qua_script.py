...
# Single QUA script generated at 2025-04-30 09:32:17.148548
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("1557103551347661921", "B2/drive")
        wait(11, "B2/acquisition")
        measure("1734797509253571966", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("1734797509253571966_B2|acquisition_I")
        r2.buffer(5000).save("1734797509253571966_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "1734797509253571966": "1734797509253571966_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1557103551347661921": "1557103551347661921",
            },
        },
    },
    "pulses": {
        "1734797509253571966_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-8812294771416349333_i",
                "Q": "-8812294771416349333_q",
            },
            "digital_marker": "ON",
        ...
        "1557103551347661921": {
            "length": 40,
            "waveforms": {
                "I": "1557103551347661921_i",
                "Q": "1557103551347661921_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-8812294771416349333_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-8812294771416349333_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1557103551347661921_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_8d2",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_8d2": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_922": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
