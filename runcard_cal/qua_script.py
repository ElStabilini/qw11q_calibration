...
# Single QUA script generated at 2025-02-17 10:51:36.557781
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-547065058191041967", "B1/drive")
        play("-5108890996043955828", "B2/drive")
        play("-7325966431821461136", "B3/drive")
        play("-3825141923180745547", "B4/drive")
        wait(11, "B1/acquisition")
        wait(11, "B2/acquisition")
        wait(11, "B4/acquisition")
        wait(11, "B3/acquisition")
        measure("1709592898531889309", "B1/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("-8447629756367243761", "B2/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("2290385810742091093", "B3/acquisition", None, dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("-8069974782513111810", "B4/acquisition", None, dual_demod.full("cos", "sin", v8), dual_demod.full("minus_sin", "cos", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("1709592898531889309_B1|acquisition_I")
        r2.buffer(5000).save("1709592898531889309_B1|acquisition_Q")
        r3.buffer(5000).save("-8447629756367243761_B2|acquisition_I")
        r4.buffer(5000).save("-8447629756367243761_B2|acquisition_Q")
        r5.buffer(5000).save("2290385810742091093_B3|acquisition_I")
        r6.buffer(5000).save("2290385810742091093_B3|acquisition_Q")
        r7.buffer(5000).save("-8069974782513111810_B4|acquisition_I")
        r8.buffer(5000).save("-8069974782513111810_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-8447629756367243761": "-8447629756367243761_B2/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "2290385810742091093": "2290385810742091093_B3/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-8069974782513111810": "-8069974782513111810_B4/acquisition",
            },
        },
        "B1/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "1709592898531889309": "1709592898531889309_B1/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-3825141923180745547": "-3825141923180745547",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-5108890996043955828": "-5108890996043955828",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-547065058191041967": "-547065058191041967",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-7325966431821461136": "-7325966431821461136",
            },
        },
    },
    "pulses": {
        "1709592898531889309_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-1571790524019185975_i",
                "Q": "-1571790524019185975_q",
            },
            "digital_marker": "ON",
        ...
        "-8447629756367243761_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-429844731771433283_i",
                "Q": "-429844731771433283_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "2290385810742091093_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "1349371158236370463_i",
                "Q": "1349371158236370463_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-8069974782513111810_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "1708889227452609302_i",
                "Q": "1708889227452609302_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-547065058191041967": {
            "length": 40,
            "waveforms": {
                "I": "-547065058191041967_i",
                "Q": "-547065058191041967_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-5108890996043955828": {
            "length": 40,
            "waveforms": {
                "I": "-5108890996043955828_i",
                "Q": "-5108890996043955828_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-7325966431821461136": {
            "length": 40,
            "waveforms": {
                "I": "-7325966431821461136_i",
                "Q": "-7325966431821461136_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-3825141923180745547": {
            "length": 40,
            "waveforms": {
                "I": "-3825141923180745547_i",
                "Q": "-3825141923180745547_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-1571790524019185975_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-1571790524019185975_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-429844731771433283_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-429844731771433283_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1349371158236370463_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "1349371158236370463_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1708889227452609302_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "1708889227452609302_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-547065058191041967_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_e22",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B3/acquisition_mixer_856",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_793",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B1/acquisition_mixer_f16",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_e22": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/acquisition_mixer_856": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_793": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/acquisition_mixer_f16": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_7fa": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_846": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/drive_mixer_f1d": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/drive_mixer_62b": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
