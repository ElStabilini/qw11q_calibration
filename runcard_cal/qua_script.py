...
# Single QUA script generated at 2025-03-23 18:54:17.536814
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("4281897018559304585", "B1/drive")
        play("5765993629553204608", "B2/drive")
        play("1601751975494096271", "B3/drive")
        play("-5188970435916500267", "B4/drive")
        wait(11, "B4/acquisition")
        wait(11, "B2/acquisition")
        wait(11, "B3/acquisition")
        wait(11, "B1/acquisition")
        measure("-4455924680619461026", "B1/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("3852477529704278565", "B2/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("-5149695701173692219", "B3/acquisition", None, dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("3644578710159965358", "B4/acquisition", None, dual_demod.full("cos", "sin", v8), dual_demod.full("minus_sin", "cos", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("-4455924680619461026_B1|acquisition_I")
        r2.buffer(5000).save("-4455924680619461026_B1|acquisition_Q")
        r3.buffer(5000).save("3852477529704278565_B2|acquisition_I")
        r4.buffer(5000).save("3852477529704278565_B2|acquisition_Q")
        r5.buffer(5000).save("-5149695701173692219_B3|acquisition_I")
        r6.buffer(5000).save("-5149695701173692219_B3|acquisition_Q")
        r7.buffer(5000).save("3644578710159965358_B4|acquisition_I")
        r8.buffer(5000).save("3644578710159965358_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-4455924680619461026": "-4455924680619461026_B1/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "3644578710159965358": "3644578710159965358_B4/acquisition",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "3852477529704278565": "3852477529704278565_B2/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-5149695701173692219": "-5149695701173692219_B3/acquisition",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1601751975494096271": "1601751975494096271",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-5188970435916500267": "-5188970435916500267",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "4281897018559304585": "4281897018559304585",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "5765993629553204608": "5765993629553204608",
            },
        },
    },
    "pulses": {
        "-4455924680619461026_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-5023950937809625790_i",
                "Q": "-5023950937809625790_q",
            },
            "digital_marker": "ON",
        ...
        "3852477529704278565_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "146377935283788762_i",
                "Q": "146377935283788762_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-5149695701173692219_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-722078080358896189_i",
                "Q": "-722078080358896189_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "3644578710159965358_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3127931721593240139_i",
                "Q": "3127931721593240139_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "4281897018559304585": {
            "length": 40,
            "waveforms": {
                "I": "4281897018559304585_i",
                "Q": "4281897018559304585_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "5765993629553204608": {
            "length": 40,
            "waveforms": {
                "I": "5765993629553204608_i",
                "Q": "5765993629553204608_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "1601751975494096271": {
            "length": 40,
            "waveforms": {
                "I": "1601751975494096271_i",
                "Q": "1601751975494096271_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-5188970435916500267": {
            "length": 40,
            "waveforms": {
                "I": "-5188970435916500267_i",
                "Q": "-5188970435916500267_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-5023950937809625790_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-5023950937809625790_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "146377935283788762_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "146377935283788762_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-722078080358896189_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-722078080358896189_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "3127931721593240139_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "3127931721593240139_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "4281897018559304585_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B1/acquisition_mixer_da8",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_93f",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_0d1",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B3/acquisition_mixer_128",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B1/acquisition_mixer_da8": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_93f": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/acquisition_mixer_0d1": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/acquisition_mixer_128": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/drive_mixer_00e": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_741": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/drive_mixer_12f": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_dba": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
