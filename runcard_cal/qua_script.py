...
# Single QUA script generated at 2025-03-23 18:39:48.341806
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v8,0.0,(v8<1.9928510028653295),(v8+0.005702005730659025)):
            align()
            play("-8053130071606214051", "B2/drive")
            wait(11, "B2/flux")
            play("-4318030339906770616"*amp(v8), "B2/flux")
            wait(16, "B2/drive")
            play("-7292039442382652182", "B2/drive")
            wait(36, "B2/acquisition")
            measure("2152504423578588031", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
            assign(v4, Cast.to_int((((v2*0.6396323988896735)-(v3*0.7686809444045309))>0.002593462025505251)))
            r1 = declare_stream()
            save(v4, r1)
            play("7880987469069466171", "B4/drive")
            wait(11, "B4/flux")
            play("-4318030339906770616"*amp(v8), "B4/flux")
            wait(16, "B4/drive")
            play("5994406192642539343", "B4/drive")
            wait(36, "B4/acquisition")
            measure("-117512508217768715", "B4/acquisition", None, dual_demod.full("cos", "sin", v5), dual_demod.full("minus_sin", "cos", v6))
            assign(v7, Cast.to_int((((v5*0.36225808599348724)-(v6*0.9320778289028954))>-0.0006247539974722703)))
            r2 = declare_stream()
            save(v7, r2)
            wait(25000, )
    with stream_processing():
        r1.buffer(350).average().save("2152504423578588031_B2|acquisition_shots")
        r2.buffer(350).average().save("-117512508217768715_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "7866884941993620616": "7866884941993620616",
                "-4318030339906770616": "-4318030339906770616",
            },
        },
        "D2/flux": {
            "singleInput": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-117512508217768715": "-117512508217768715_B4/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-8053130071606214051": "-8053130071606214051",
                "-7292039442382652182": "-7292039442382652182",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7880987469069466171": "7880987469069466171",
                "5994406192642539343": "5994406192642539343",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "2152504423578588031": "2152504423578588031_B2/acquisition",
            },
        },
    },
    "pulses": {
        "-8053130071606214051": {
            "length": 40,
            "waveforms": {
                "I": "-8053130071606214051_i",
                "Q": "-8053130071606214051_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "7866884941993620616": {
            "length": 60,
            "waveforms": {
                "single": "7866884941993620616",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2152504423578588031_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3494276964763402016_i",
                "Q": "3494276964763402016_q",
            },
            "digital_marker": "ON",
        ...
        "7880987469069466171": {
            "length": 40,
            "waveforms": {
                "I": "7880987469069466171_i",
                "Q": "7880987469069466171_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-117512508217768715_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "5633010923987444601_i",
                "Q": "5633010923987444601_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-7292039442382652182": {
            "length": 40,
            "waveforms": {
                "I": "-7292039442382652182_i",
                "Q": "-7292039442382652182_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "5994406192642539343": {
            "length": 40,
            "waveforms": {
                "I": "5994406192642539343_i",
                "Q": "5994406192642539343_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "3494276964763402016_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "3494276964763402016_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "7880987469069466171_i": {
        ...
        "5633010923987444601_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "5633010923987444601_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-4318030339906770616": {
        ...
        "-7292039442382652182_i": {
            "samples": [0.0012493039327485741, 0.0016811221929452756, 0.0022271250587747485, 0.0029047186704985986, 0.0037297326012476254, 0.004714823786424647, 0.00586769300677935, 0.007189247754539428, 0.008671888112107319, 0.010298121937161474, 0.01203972431763831, 0.013857637745628482, 0.01570276077461938, 0.017517695516533722, 0.019239424678246013, 0.020802778144181227, 0.022144442064578468, 0.023207176028356858, 0.023943850873928398] + [0.024320911659934084] * 2 + [0.023943850873928398, 0.023207176028356858, 0.022144442064578468, 0.020802778144181227, 0.019239424678246013, 0.017517695516533722, 0.01570276077461938, 0.013857637745628482, 0.01203972431763831, 0.010298121937161474, 0.008671888112107319, 0.007189247754539428, 0.00586769300677935, 0.004714823786424647, 0.0037297326012476254, 0.0029047186704985986, 0.0022271250587747485, 0.0016811221929452756, 0.0012493039327485741],
            "type": "arbitrary",
        },
        "-7292039442382652182_q": {
        ...
        "5994406192642539343_i": {
            "samples": [0.0019126784932123073, 0.0025737902352024828, 0.0034097180757614314, 0.004447110734432495, 0.005710203213836212, 0.0072183732230314875, 0.008983410621423042, 0.011006704775378151, 0.013276620246507487, 0.015766376646515118, 0.018432761766696917, 0.021215978744641418, 0.02404085349478909, 0.026819510118246643, 0.02945546943320567, 0.031848956296730166, 0.033903037500186334, 0.03553007824122775, 0.036657923993314044] + [0.03723520229775363] * 2 + [0.036657923993314044, 0.03553007824122775, 0.033903037500186334, 0.031848956296730166, 0.02945546943320567, 0.026819510118246643, 0.02404085349478909, 0.021215978744641418, 0.018432761766696917, 0.015766376646515118, 0.013276620246507487, 0.011006704775378151, 0.008983410621423042, 0.0072183732230314875, 0.005710203213836212, 0.004447110734432495, 0.0034097180757614314, 0.0025737902352024828, 0.0019126784932123073],
            "type": "arbitrary",
        },
        "5994406192642539343_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_6ab",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_a31",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B4/acquisition_mixer_6ab": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_310": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_f14": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/acquisition_mixer_a31": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
