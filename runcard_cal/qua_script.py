...
# Single QUA script generated at 2025-03-25 20:24:31.439145
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-497994403748161837", "B2/drive")
        wait(11, "B2/acquisition")
        measure("9053242403722291567", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("9053242403722291567_B2|acquisition_I")
        r2.buffer(5000).save("9053242403722291567_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "9053242403722291567": "9053242403722291567_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-497994403748161837": "-497994403748161837",
            },
        },
    },
    "pulses": {
        "-602002428064984811_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-6177945622167365492_i",
                "Q": "-6177945622167365492_q",
            },
            "digital_marker": "ON",
        ...
        "-497994403748161837": {
            "length": 40,
            "waveforms": {
                "I": "-497994403748161837_i",
                "Q": "-497994403748161837_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "9053242403722291567_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7560792413819824272_i",
                "Q": "-7560792413819824272_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
    ...
    "waveforms": {
        "-6177945622167365492_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-6177945622167365492_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-497994403748161837_i": {
        ...
        "-7560792413819824272_i": {
            "sample": 0.002,
            "type": "constant",
        },
        "-7560792413819824272_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_afc",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_afc": [{'intermediate_frequency': 9740944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_fa3": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
