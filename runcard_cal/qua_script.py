...
# Single QUA script generated at 2025-01-15 11:07:47.013776
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.9919939879759516),(v5+0.003987975951903807)):
            align()
            play("1239367842976206343", "B4/drive")
            wait(11, "B4/flux")
            play("4585378599756214025"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("2000458472199768212", "B4/drive")
            wait(36, "B4/acquisition")
            measure("-103211911565576652", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*-0.4386401275063697)-(v3*-0.8986628058071591))>0.0021321279781268726)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(500).average().save("-103211911565576652_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "-2615464746649666406": "-2615464746649666406",
                "4585378599756214025": "4585378599756214025",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/drive": {
            ...
            "operations": {
                "1239367842976206343": "1239367842976206343",
                "2000458472199768212": "2000458472199768212",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-103211911565576652": "-103211911565576652_B4/acquisition",
            },
        },
    },
    "pulses": {
        "1239367842976206343": {
            "length": 40,
            "waveforms": {
                "I": "1239367842976206343_i",
                "Q": "1239367842976206343_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-2615464746649666406": {
            "length": 60,
            "waveforms": {
                "single": "-2615464746649666406",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-103211911565576652_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-1450509686102918237_i",
                "Q": "-1450509686102918237_q",
            },
            "digital_marker": "ON",
        ...
        "2000458472199768212": {
            "length": 40,
            "waveforms": {
                "I": "2000458472199768212_i",
                "Q": "2000458472199768212_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "-1450509686102918237_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-1450509686102918237_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "4585378599756214025": {
        ...
        "2000458472199768212_i": {
            "samples": [0.0019122312051685873, 0.0025731883433511684, 0.0034089206986104067, 0.004446070758572637, 0.005708867858399413, 0.007216685175589522, 0.008981309812438653, 0.011004130810404815, 0.013273515452095699, 0.01576268961192368, 0.018428451186544403, 0.021211017297298348, 0.024035231438407318, 0.026813238261132712, 0.029448581145735307, 0.031841508282122885, 0.033895109129906946, 0.03552176938051429, 0.036649351381049106] + [0.03722649468648891] * 2 + [0.036649351381049106, 0.03552176938051429, 0.033895109129906946, 0.031841508282122885, 0.029448581145735307, 0.026813238261132712, 0.024035231438407318, 0.021211017297298348, 0.018428451186544403, 0.01576268961192368, 0.013273515452095699, 0.011004130810404815, 0.008981309812438653, 0.007216685175589522, 0.005708867858399413, 0.004446070758572637, 0.0034089206986104067, 0.0025731883433511684, 0.0019122312051685873],
            "type": "arbitrary",
        },
        "2000458472199768212_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_b8c",
                "lo_frequency": 7370000000.0,
            },
        },
    },
    ...
    "mixers": {
        "B4/drive_mixer_df3": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/acquisition_mixer_b8c": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
