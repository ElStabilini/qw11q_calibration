...
# Single QUA script generated at 2025-01-16 15:40:52.389426
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.9914234620886984),(v5+0.00284692417739628)):
            align()
            play("-6920776873937971885", "B4/drive")
            wait(11, "B4/flux")
            play("-7795609249091595480"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("-6159686244714410016", "B4/drive")
            wait(36, "B4/acquisition")
            measure("-2101816600137789895", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*-0.4386401275063697)-(v3*-0.8986628058071591))>0.0021321279781268726)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(700).average().save("-2101816600137789895_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "2685475292516761962": "2685475292516761962",
                "-7795609249091595480": "-7795609249091595480",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-2101816600137789895": "-2101816600137789895_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-6920776873937971885": "-6920776873937971885",
                "-6159686244714410016": "-6159686244714410016",
            },
        },
    },
    "pulses": {
        "-6920776873937971885": {
            "length": 40,
            "waveforms": {
                "I": "-6920776873937971885_i",
                "Q": "-6920776873937971885_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "2685475292516761962": {
            "length": 60,
            "waveforms": {
                "single": "2685475292516761962",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-2101816600137789895_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "4319116622598483124_i",
                "Q": "4319116622598483124_q",
            },
            "digital_marker": "ON",
        ...
        "-6159686244714410016": {
            "length": 40,
            "waveforms": {
                "I": "-6159686244714410016_i",
                "Q": "-6159686244714410016_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "4319116622598483124_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "4319116622598483124_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7795609249091595480": {
        ...
        "-6159686244714410016_i": {
            "samples": [0.0019122312051685873, 0.0025731883433511684, 0.0034089206986104067, 0.004446070758572637, 0.005708867858399413, 0.007216685175589522, 0.008981309812438653, 0.011004130810404815, 0.013273515452095699, 0.01576268961192368, 0.018428451186544403, 0.021211017297298348, 0.024035231438407318, 0.026813238261132712, 0.029448581145735307, 0.031841508282122885, 0.033895109129906946, 0.03552176938051429, 0.036649351381049106] + [0.03722649468648891] * 2 + [0.036649351381049106, 0.03552176938051429, 0.033895109129906946, 0.031841508282122885, 0.029448581145735307, 0.026813238261132712, 0.024035231438407318, 0.021211017297298348, 0.018428451186544403, 0.01576268961192368, 0.013273515452095699, 0.011004130810404815, 0.008981309812438653, 0.007216685175589522, 0.005708867858399413, 0.004446070758572637, 0.0034089206986104067, 0.0025731883433511684, 0.0019122312051685873],
            "type": "arbitrary",
        },
        "-6159686244714410016_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_990",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_990": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_add": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
