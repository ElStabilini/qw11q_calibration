...
# Single QUA script generated at 2025-01-16 16:57:23.438586
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.9914234620886984),(v5+0.00284692417739628)):
            align()
            play("1301635965834771821", "B4/drive")
            wait(11, "B4/flux")
            play("-7212068514372383512"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("-4983302693576523135", "B4/drive")
            wait(36, "B4/acquisition")
            measure("8504068009896954388", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*-0.26143754955026)-(v3*-0.9652203933222481))>0.002215054761521925)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(700).average().save("8504068009896954388_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "-8131698757838720861": "-8131698757838720861",
                "-7212068514372383512": "-7212068514372383512",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "8504068009896954388": "8504068009896954388_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1301635965834771821": "1301635965834771821",
                "-4983302693576523135": "-4983302693576523135",
            },
        },
    },
    "pulses": {
        "1301635965834771821": {
            "length": 40,
            "waveforms": {
                "I": "1301635965834771821_i",
                "Q": "1301635965834771821_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-8131698757838720861": {
            "length": 60,
            "waveforms": {
                "single": "-8131698757838720861",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8504068009896954388_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3145563257569002285_i",
                "Q": "3145563257569002285_q",
            },
            "digital_marker": "ON",
        ...
        "-4983302693576523135": {
            "length": 40,
            "waveforms": {
                "I": "-4983302693576523135_i",
                "Q": "-4983302693576523135_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "3145563257569002285_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "3145563257569002285_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7212068514372383512": {
        ...
        "-4983302693576523135_i": {
            "samples": [0.0019122312051685873, 0.0025731883433511684, 0.0034089206986104067, 0.004446070758572637, 0.005708867858399413, 0.007216685175589522, 0.008981309812438653, 0.011004130810404815, 0.013273515452095699, 0.01576268961192368, 0.018428451186544403, 0.021211017297298348, 0.024035231438407318, 0.026813238261132712, 0.029448581145735307, 0.031841508282122885, 0.033895109129906946, 0.03552176938051429, 0.036649351381049106] + [0.03722649468648891] * 2 + [0.036649351381049106, 0.03552176938051429, 0.033895109129906946, 0.031841508282122885, 0.029448581145735307, 0.026813238261132712, 0.024035231438407318, 0.021211017297298348, 0.018428451186544403, 0.01576268961192368, 0.013273515452095699, 0.011004130810404815, 0.008981309812438653, 0.007216685175589522, 0.005708867858399413, 0.004446070758572637, 0.0034089206986104067, 0.0025731883433511684, 0.0019122312051685873],
            "type": "arbitrary",
        },
        "-4983302693576523135_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_847",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_847": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_b79": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
