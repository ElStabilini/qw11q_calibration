...
# Single QUA script generated at 2024-11-20 07:45:06.941528
...
with program() as prog:
    ...
    with for_(v1,0,(v1<1024),(v1+1)):
        with for_(v4,0.14214285714285713,(v4<2.061071428571428),(v4+0.14214285714285713)):
            align()
            play("3902449217476579598"*amp(v4), "D1/drive")
            play("3902449217476579598"*amp(v4), "D1/drive")
            wait(11, "D1/acquisition")
            measure("-8711832612636609000", "D1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            r1 = declare_stream()
            save(v2, r1)
            r2 = declare_stream()
            save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(14).average().save("-8711832612636609000_D1|acquisition_I")
        r2.buffer(14).average().save("-8711832612636609000_D1|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "intermediate_frequency": -312363795.62439823,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "-8711832612636609000": "-8711832612636609000_D1/acquisition",
            },
        },
        "D1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-3319638103219979794": "-3319638103219979794",
                "3902449217476579598": "3902449217476579598",
            },
        },
    },
    "pulses": {
        "-8711832612636609000_D1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "3382329681501973058_i",
                "Q": "3382329681501973058_q",
            },
            "digital_marker": "ON",
        ...
        "-3319638103219979794": {
            "length": 40,
            "waveforms": {
                "I": "-3319638103219979794_i",
                "Q": "-3319638103219979794_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "3902449217476579598": {
            "length": 40,
            "waveforms": {
                "I": "3902449217476579598_i",
                "Q": "3902449217476579598_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "3382329681501973058_i": {
            "sample": 0.0005,
            "type": "constant",
        },
        "3382329681501973058_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-3319638103219979794_i": {
        ...
        "-3319638103219979794_q": {
            "samples": [0.0] * 40,
            "type": "arbitrary",
        },
        "3902449217476579598_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "D1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con6', 1),
                "Q": ('con6', 2),
                "mixer": "D1/acquisition_mixer_081",
                "lo_frequency": 7450000000.0,
            },
        },
        "D1/drive": {
    ...
    "mixers": {
        "D1/acquisition_mixer_081": [{'intermediate_frequency': -312363795.62439823, 'lo_frequency': 7450000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "D1/drive_mixer_aff": [{'intermediate_frequency': -141729925.0, 'lo_frequency': 5100000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
