...
# Single QUA script generated at 2025-01-15 07:34:02.610365
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("-8552007883877901885", "B2/drive")
        wait(11, "B2/acquisition")
        measure("-1499728814839754012", "B2/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("-1499728814839754012_B2|acquisition_I")
        r2.buffer(5000).save("-1499728814839754012_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-1499728814839754012": "-1499728814839754012_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-8552007883877901885": "-8552007883877901885",
            },
        },
    },
    "pulses": {
        "-1499728814839754012_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "881482292294975577_i",
                "Q": "881482292294975577_q",
            },
            "digital_marker": "ON",
        ...
        "-8552007883877901885": {
            "length": 40,
            "waveforms": {
                "I": "-8552007883877901885_i",
                "Q": "-8552007883877901885_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "881482292294975577_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "881482292294975577_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-8552007883877901885_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B2/acquisition_mixer_e60",
                "lo_frequency": 7370000000.0,
            },
        },
        "B2/drive": {
    ...
    "mixers": {
        "B2/acquisition_mixer_e60": [{'intermediate_frequency': 10073341.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/drive_mixer_b1f": [{'intermediate_frequency': 63692382.0, 'lo_frequency': 5900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
