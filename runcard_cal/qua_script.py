...
# Single QUA script generated at 2025-04-14 17:42:56.320756
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,1.9900000000000002,(v5<=1.9900000000000002),(v5+1)):
            with for_(v6,9978444,(v6<=9978444),(v6+1)):
                update_frequency("B2/acquisition", v6, "Hz", False)
                align()
                play("-6138265263828741317", "B2/drive")
                wait(11, "B2/acquisition")
                measure("2602283290639064393"*amp(v5), "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
    ...
    with stream_processing():
        r1.buffer(2).buffer(1).buffer(1).buffer(2048).save("2602283290639064393_B2|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "2602283290639064393": "2602283290639064393_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-6138265263828741317": "-6138265263828741317",
            },
        },
    },
    "pulses": {
        "2602283290639064393_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-3228402826396658645_i",
                "Q": "-3228402826396658645_q",
            },
            "digital_marker": "ON",
        ...
        "-6138265263828741317": {
            "length": 40,
            "waveforms": {
                "I": "-6138265263828741317_i",
                "Q": "-6138265263828741317_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-3228402826396658645_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-3228402826396658645_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-6138265263828741317_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_7c6",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_7c6": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_800": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
