...
# Single QUA script generated at 2025-02-07 14:05:28.585165
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("1502620621722712221", "B1/drive")
        play("7415214906845929439", "B2/drive")
        play("-4189037038403694561", "B3/drive")
        play("1736409426087437815", "B4/drive")
        wait(11, "B4/acquisition")
        wait(11, "B1/acquisition")
        wait(11, "B3/acquisition")
        wait(11, "B2/acquisition")
        measure("1869286467767623445", "B1/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("-5640264281481020928", "B2/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v4), dual_demod.full("minus_sin", "out1", "cos", "out2", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("2941958435645689495", "B3/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v6), dual_demod.full("minus_sin", "out1", "cos", "out2", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("5843755449890445625", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v8), dual_demod.full("minus_sin", "out1", "cos", "out2", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("1869286467767623445_B1|acquisition_I")
        r2.buffer(5000).save("1869286467767623445_B1|acquisition_Q")
        r3.buffer(5000).save("-5640264281481020928_B2|acquisition_I")
        r4.buffer(5000).save("-5640264281481020928_B2|acquisition_Q")
        r5.buffer(5000).save("2941958435645689495_B3|acquisition_I")
        r6.buffer(5000).save("2941958435645689495_B3|acquisition_Q")
        r7.buffer(5000).save("5843755449890445625_B4|acquisition_I")
        r8.buffer(5000).save("5843755449890445625_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "1869286467767623445": "1869286467767623445_B1/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "2941958435645689495": "2941958435645689495_B3/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "5843755449890445625": "5843755449890445625_B4/acquisition",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-5640264281481020928": "-5640264281481020928_B2/acquisition",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1502620621722712221": "1502620621722712221",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-4189037038403694561": "-4189037038403694561",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "1736409426087437815": "1736409426087437815",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7415214906845929439": "7415214906845929439",
            },
        },
    },
    "pulses": {
        "1869286467767623445_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-8019322257104696104_i",
                "Q": "-8019322257104696104_q",
            },
            "digital_marker": "ON",
        ...
        "-5640264281481020928_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-6877376464856943412_i",
                "Q": "-6877376464856943412_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "2941958435645689495_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7672020302810149134_i",
                "Q": "-7672020302810149134_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "5843755449890445625_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "5403666642307818619_i",
                "Q": "5403666642307818619_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "1502620621722712221": {
            "length": 40,
            "waveforms": {
                "I": "1502620621722712221_i",
                "Q": "1502620621722712221_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "7415214906845929439": {
            "length": 40,
            "waveforms": {
                "I": "7415214906845929439_i",
                "Q": "7415214906845929439_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-4189037038403694561": {
            "length": 40,
            "waveforms": {
                "I": "-4189037038403694561_i",
                "Q": "-4189037038403694561_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "1736409426087437815": {
            "length": 40,
            "waveforms": {
                "I": "1736409426087437815_i",
                "Q": "1736409426087437815_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-8019322257104696104_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-8019322257104696104_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-6877376464856943412_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-6877376464856943412_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7672020302810149134_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-7672020302810149134_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "5403666642307818619_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "5403666642307818619_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1502620621722712221_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B1/acquisition_mixer_090",
                "lo_frequency": 7370000000.0,
            },
        },
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B3/acquisition_mixer_9c7",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/acquisition": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B2/acquisition_mixer_bf6",
                "lo_frequency": 7370000000.0,
            },
        },
        "B1/drive": {
    ...
    "mixers": {
        "B1/acquisition_mixer_090": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B3/acquisition_mixer_9c7": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/acquisition_mixer_e4d": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/acquisition_mixer_bf6": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B1/drive_mixer_f2e": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B3/drive_mixer_b78": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_bd3": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B2/drive_mixer_5d7": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
