...
# Single QUA script generated at 2025-01-17 17:23:38.048371
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("8669904407060372020", "B4/drive")
        wait(11, "B4/acquisition")
        measure("1198439208351729958", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("1198439208351729958_B4|acquisition_I")
        r2.buffer(5000).save("1198439208351729958_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "1198439208351729958": "1198439208351729958_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "8669904407060372020": "8669904407060372020",
            },
        },
    },
    "pulses": {
        "1198439208351729958_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-2862083422964465313_i",
                "Q": "-2862083422964465313_q",
            },
            "digital_marker": "ON",
        ...
        "8669904407060372020": {
            "length": 40,
            "waveforms": {
                "I": "8669904407060372020_i",
                "Q": "8669904407060372020_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-2862083422964465313_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-2862083422964465313_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "8669904407060372020_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_13b",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_13b": [{'intermediate_frequency': 330298316.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_f30": [{'intermediate_frequency': 109678455.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
