...
# Single QUA script generated at 2025-02-14 13:41:57.915295
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("6572661352616742358", "B1/drive")
        play("-6648617556189949092", "B2/drive")
        play("193874572269978524", "B3/drive")
        play("7451538851584565474", "B4/drive")
        wait(11, "B3/acquisition")
        wait(11, "B1/acquisition")
        wait(11, "B2/acquisition")
        wait(11, "B4/acquisition")
        measure("-4295442929927743111", "B1/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("2131886166465716561", "B2/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("-6180563526513716834", "B3/acquisition", None, dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("7597622061202754029", "B4/acquisition", None, dual_demod.full("cos", "sin", v8), dual_demod.full("minus_sin", "cos", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("-4295442929927743111_B1|acquisition_I")
        r2.buffer(5000).save("-4295442929927743111_B1|acquisition_Q")
        r3.buffer(5000).save("2131886166465716561_B2|acquisition_I")
        r4.buffer(5000).save("2131886166465716561_B2|acquisition_Q")
        r5.buffer(5000).save("-6180563526513716834_B3|acquisition_I")
        r6.buffer(5000).save("-6180563526513716834_B3|acquisition_Q")
        r7.buffer(5000).save("7597622061202754029_B4|acquisition_I")
        r8.buffer(5000).save("7597622061202754029_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-4295442929927743111": "-4295442929927743111_B1/acquisition",
            },
        },
        "B2/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "2131886166465716561": "2131886166465716561_B2/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "7597622061202754029": "7597622061202754029_B4/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-6180563526513716834": "-6180563526513716834_B3/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7451538851584565474": "7451538851584565474",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "193874572269978524": "193874572269978524",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "6572661352616742358": "6572661352616742358",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-6648617556189949092": "-6648617556189949092",
            },
        },
    },
    "pulses": {
        "-4295442929927743111_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-482352330664587158_i",
                "Q": "-482352330664587158_q",
            },
            "digital_marker": "ON",
        ...
        "2131886166465716561_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "1546085175213104488_i",
                "Q": "1546085175213104488_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-6180563526513716834_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-3720728223413948591_i",
                "Q": "-3720728223413948591_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "7597622061202754029_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-713538248547221055_i",
                "Q": "-713538248547221055_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "6572661352616742358": {
            "length": 40,
            "waveforms": {
                "I": "6572661352616742358_i",
                "Q": "6572661352616742358_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-6648617556189949092": {
            "length": 40,
            "waveforms": {
                "I": "-6648617556189949092_i",
                "Q": "-6648617556189949092_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "193874572269978524": {
            "length": 40,
            "waveforms": {
                "I": "193874572269978524_i",
                "Q": "193874572269978524_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "7451538851584565474": {
            "length": 40,
            "waveforms": {
                "I": "7451538851584565474_i",
                "Q": "7451538851584565474_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-482352330664587158_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-482352330664587158_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1546085175213104488_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "1546085175213104488_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-3720728223413948591_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-3720728223413948591_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-713538248547221055_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-713538248547221055_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "6572661352616742358_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B1/acquisition_mixer_15a",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_3ae",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B3/acquisition_mixer_6a6",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B1/acquisition_mixer_15a": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/acquisition_mixer_3ae": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_7ac": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/acquisition_mixer_6a6": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_3f9": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/drive_mixer_34b": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/drive_mixer_206": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_e29": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
