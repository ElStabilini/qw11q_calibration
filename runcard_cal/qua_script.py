...
# Single QUA script generated at 2025-02-17 10:10:56.138313
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("8086191658455224674", "B1/drive")
        play("-3719394700514857282", "B2/drive")
        play("-7883636354573965619", "B3/drive")
        play("7632851342599593216", "B4/drive")
        wait(11, "B2/acquisition")
        wait(11, "B4/acquisition")
        wait(11, "B1/acquisition")
        wait(11, "B3/acquisition")
        measure("5540055987898219398", "B1/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
        measure("-7722079325707527778", "B2/acquisition", None, dual_demod.full("cos", "sin", v4), dual_demod.full("minus_sin", "cos", v5))
        r3 = declare_stream()
        save(v4, r3)
        r4 = declare_stream()
        save(v5, r4)
        measure("-2970215893417675263", "B3/acquisition", None, dual_demod.full("cos", "sin", v6), dual_demod.full("minus_sin", "cos", v7))
        r5 = declare_stream()
        save(v6, r5)
        r6 = declare_stream()
        save(v7, r6)
        measure("-3844138182805604521", "B4/acquisition", None, dual_demod.full("cos", "sin", v8), dual_demod.full("minus_sin", "cos", v9))
        r7 = declare_stream()
        save(v8, r7)
        r8 = declare_stream()
        save(v9, r8)
    ...
    with stream_processing():
        r1.buffer(5000).save("5540055987898219398_B1|acquisition_I")
        r2.buffer(5000).save("5540055987898219398_B1|acquisition_Q")
        r3.buffer(5000).save("-7722079325707527778_B2|acquisition_I")
        r4.buffer(5000).save("-7722079325707527778_B2|acquisition_Q")
        r5.buffer(5000).save("-2970215893417675263_B3|acquisition_I")
        r6.buffer(5000).save("-2970215893417675263_B3|acquisition_Q")
        r7.buffer(5000).save("-3844138182805604521_B4|acquisition_I")
        r8.buffer(5000).save("-3844138182805604521_B4|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-7722079325707527778": "-7722079325707527778_B2/acquisition",
            },
        },
        "B1/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "5540055987898219398": "5540055987898219398_B1/acquisition",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-3844138182805604521": "-3844138182805604521_B4/acquisition",
            },
        },
        "B3/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "-2970215893417675263": "-2970215893417675263_B3/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "7632851342599593216": "7632851342599593216",
            },
        },
        "B3/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-7883636354573965619": "-7883636354573965619",
            },
        },
        "B1/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "8086191658455224674": "8086191658455224674",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-3719394700514857282": "-3719394700514857282",
            },
        },
    },
    "pulses": {
        "5540055987898219398_B1/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-2036095666821196396_i",
                "Q": "-2036095666821196396_q",
            },
            "digital_marker": "ON",
        ...
        "-7722079325707527778_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "1753522031077044993_i",
                "Q": "1753522031077044993_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-2970215893417675263_B3/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7419368910334472128_i",
                "Q": "-7419368910334472128_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "-3844138182805604521_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6988535849606950199_i",
                "Q": "6988535849606950199_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
        ...
        "8086191658455224674": {
            "length": 40,
            "waveforms": {
                "I": "8086191658455224674_i",
                "Q": "8086191658455224674_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-3719394700514857282": {
            "length": 40,
            "waveforms": {
                "I": "-3719394700514857282_i",
                "Q": "-3719394700514857282_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "-7883636354573965619": {
            "length": 40,
            "waveforms": {
                "I": "-7883636354573965619_i",
                "Q": "-7883636354573965619_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "7632851342599593216": {
            "length": 40,
            "waveforms": {
                "I": "7632851342599593216_i",
                "Q": "7632851342599593216_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-2036095666821196396_i": {
            "sample": 0.0031,
            "type": "constant",
        },
        "-2036095666821196396_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "1753522031077044993_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "1753522031077044993_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-7419368910334472128_i": {
            "sample": 0.0017,
            "type": "constant",
        },
        "-7419368910334472128_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "6988535849606950199_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "6988535849606950199_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "8086191658455224674_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_b4c",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B1/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B1/acquisition_mixer_44d",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B4/acquisition_mixer_d70",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
        ...
        "B3/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B3/acquisition_mixer_3eb",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_b4c": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/acquisition_mixer_44d": [{'intermediate_frequency': -237451236.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/acquisition_mixer_d70": [{'intermediate_frequency': 330300527.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/acquisition_mixer_3eb": [{'intermediate_frequency': 110622376.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B4/drive_mixer_a71": [{'intermediate_frequency': 109615374.0, 'lo_frequency': 6700000000.0, 'correction': (1, 0, 0, 1)}],
        "B3/drive_mixer_ee0": [{'intermediate_frequency': -115376210.0, 'lo_frequency': 5800000000.0, 'correction': (1, 0, 0, 1)}],
        "B1/drive_mixer_e30": [{'intermediate_frequency': 100388701.0, 'lo_frequency': 4900000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_d18": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
