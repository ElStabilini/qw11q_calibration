...
# Single QUA script generated at 2025-01-16 16:21:24.358151
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.997158273381295),(v5+0.014316546762589928)):
            align()
            play("4487692641261712225", "B4/drive")
            wait(11, "B4/flux")
            play("-734070875347856631"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("5248783270485274094", "B4/drive")
            wait(36, "B4/acquisition")
            measure("4987507027981683163", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*-0.4386401275063697)-(v3*-0.8986628058071591))>0.0021321279781268726)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(140).average().save("4987507027981683163_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "8575644302589134967": "8575644302589134967",
                "-734070875347856631": "-734070875347856631",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "4987507027981683163": "4987507027981683163_B4/acquisition",
            },
        },
        "B4/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "4487692641261712225": "4487692641261712225",
                "5248783270485274094": "5248783270485274094",
            },
        },
    },
    "pulses": {
        "4487692641261712225": {
            "length": 40,
            "waveforms": {
                "I": "4487692641261712225_i",
                "Q": "4487692641261712225_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8575644302589134967": {
            "length": 60,
            "waveforms": {
                "single": "8575644302589134967",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "4987507027981683163_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "6254714729514673498_i",
                "Q": "6254714729514673498_q",
            },
            "digital_marker": "ON",
        ...
        "5248783270485274094": {
            "length": 40,
            "waveforms": {
                "I": "5248783270485274094_i",
                "Q": "5248783270485274094_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "6254714729514673498_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "6254714729514673498_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-734070875347856631": {
        ...
        "5248783270485274094_i": {
            "samples": [0.0019122312051685873, 0.0025731883433511684, 0.0034089206986104067, 0.004446070758572637, 0.005708867858399413, 0.007216685175589522, 0.008981309812438653, 0.011004130810404815, 0.013273515452095699, 0.01576268961192368, 0.018428451186544403, 0.021211017297298348, 0.024035231438407318, 0.026813238261132712, 0.029448581145735307, 0.031841508282122885, 0.033895109129906946, 0.03552176938051429, 0.036649351381049106] + [0.03722649468648891] * 2 + [0.036649351381049106, 0.03552176938051429, 0.033895109129906946, 0.031841508282122885, 0.029448581145735307, 0.026813238261132712, 0.024035231438407318, 0.021211017297298348, 0.018428451186544403, 0.01576268961192368, 0.013273515452095699, 0.011004130810404815, 0.008981309812438653, 0.007216685175589522, 0.005708867858399413, 0.004446070758572637, 0.0034089206986104067, 0.0025731883433511684, 0.0019122312051685873],
            "type": "arbitrary",
        },
        "5248783270485274094_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_f7f",
                "lo_frequency": 7370000000.0,
            },
        },
        "B4/drive": {
    ...
    "mixers": {
        "B4/acquisition_mixer_f7f": [{'intermediate_frequency': 331181947.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/drive_mixer_699": [{'intermediate_frequency': 109610828.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
