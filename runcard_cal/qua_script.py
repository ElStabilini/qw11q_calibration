...
# Single QUA script generated at 2025-04-12 00:54:11.682163
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.5632075471698111,(v5<2.0275471698113208),(v5+0.07509433962264156)):
            with for_(v6,9040944,(v6<=10940944),(v6+100000)):
                update_frequency("B2/acquisition", v6, "Hz", False)
                align()
                play("-8167015995055125407", "B2/drive")
                wait(11, "B2/acquisition")
                measure("-4996544680268695906"*amp(v5), "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
                assign(v4, Cast.to_int((((v2*0.7182173787452281)-(v3*0.6958187960010377))>0.0025039672472700306)))
                r1 = declare_stream()
                save(v4, r1)
    ...
    with stream_processing():
        r1.buffer(2).buffer(20).buffer(20).buffer(2048).save("-4996544680268695906_B2|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "smearing": 0.0,
            "operations": {
                "-4996544680268695906": "-4996544680268695906_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "-8167015995055125407": "-8167015995055125407",
            },
        },
    },
    "pulses": {
        "-4996544680268695906_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-3970924065604625119_i",
                "Q": "-3970924065604625119_q",
            },
            "digital_marker": "ON",
        ...
        "-8167015995055125407": {
            "length": 40,
            "waveforms": {
                "I": "-8167015995055125407_i",
                "Q": "-8167015995055125407_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        "-3970924065604625119_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "-3970924065604625119_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-8167015995055125407_i": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_89c",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_89c": [{'intermediate_frequency': 10040944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_4ce": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
