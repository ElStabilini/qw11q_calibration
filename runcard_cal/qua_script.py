...
# Single QUA script generated at 2025-01-17 17:53:03.136967
...
with program() as prog:
    ...
    with for_(v1,0,(v1<2048),(v1+1)):
        with for_(v5,0.0,(v5<1.9914234620886984),(v5+0.00284692417739628)):
            align()
            play("-1270774888198114095", "B4/drive")
            wait(11, "B4/flux")
            play("-1909625803090353053"*amp(v5), "B4/flux")
            wait(16, "B4/drive")
            play("-509684258974552226", "B4/drive")
            wait(36, "B4/acquisition")
            measure("1027556417871608209", "B4/acquisition", None, dual_demod.full("cos", "out1", "sin", "out2", v2), dual_demod.full("minus_sin", "out1", "cos", "out2", v3))
            assign(v4, Cast.to_int((((v2*0.35365058764385754)-(v3*0.9353776038900836))>-0.00036830886943236044)))
            r1 = declare_stream()
            save(v4, r1)
            wait(25000, )
    with stream_processing():
        r1.buffer(700).average().save("1027556417871608209_B4|acquisition_shots")
...
config = {
    ...
    "elements": {
        ...
        "B4/flux": {
            ...
            "intermediate_frequency": 0,
            "operations": {
                "8571458738518004389": "8571458738518004389",
                "-1909625803090353053": "-1909625803090353053",
            },
        },
        "D4/flux": {
            "singleInput": {
        ...
        "B4/drive": {
            ...
            "operations": {
                "-1270774888198114095": "-1270774888198114095",
                "-509684258974552226": "-509684258974552226",
            },
        },
        "B4/acquisition": {
            "RF_inputs": {
            ...
            "smearing": 0.0,
            "operations": {
                "1027556417871608209": "1027556417871608209_B4/acquisition",
            },
        },
    },
    "pulses": {
        "-1270774888198114095": {
            "length": 40,
            "waveforms": {
                "I": "-1270774888198114095_i",
                "Q": "-1270774888198114095_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "8571458738518004389": {
            "length": 60,
            "waveforms": {
                "single": "8571458738518004389",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "1027556417871608209_B4/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-8629422228482934851_i",
                "Q": "-8629422228482934851_q",
            },
            "digital_marker": "ON",
        ...
        "-509684258974552226": {
            "length": 40,
            "waveforms": {
                "I": "-509684258974552226_i",
                "Q": "-509684258974552226_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "-8629422228482934851_i": {
            "sample": 0.0033,
            "type": "constant",
        },
        "-8629422228482934851_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "-1909625803090353053": {
        ...
        "-509684258974552226_i": {
            "samples": [0.0019041597662755052, 0.002562327035148681, 0.0033945318030438945, 0.004427304100887551, 0.005684770992945484, 0.007186223883436177, 0.008943400121845278, 0.010957682886551467, 0.01321748856132099, 0.015696156032903856, 0.01835066555202265, 0.02112148658076548, 0.023933779845466133, 0.02670006083072293, 0.02932428005569802, 0.03170710675804564, 0.0337520394522566, 0.03537183364567531, 0.03649465617508045] + [0.03706936338549691] * 2 + [0.03649465617508045, 0.03537183364567531, 0.0337520394522566, 0.03170710675804564, 0.02932428005569802, 0.02670006083072293, 0.023933779845466133, 0.02112148658076548, 0.01835066555202265, 0.015696156032903856, 0.01321748856132099, 0.010957682886551467, 0.008943400121845278, 0.007186223883436177, 0.005684770992945484, 0.004427304100887551, 0.0033945318030438945, 0.002562327035148681, 0.0019041597662755052],
            "type": "arbitrary",
        },
        "-509684258974552226_q": {
...
loaded_config = {
    ...
    "elements": {
        ...
        "B4/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1),
                "Q": ('con2', 2),
                "mixer": "B4/acquisition_mixer_d8b",
                "lo_frequency": 7370000000.0,
            },
        },
    },
    ...
    "mixers": {
        "B4/drive_mixer_228": [{'intermediate_frequency': 109678455.0, 'lo_frequency': 6700000000.0, 'correction': [1, 0.0, 0.0, 1]}],
        "B4/acquisition_mixer_d8b": [{'intermediate_frequency': 330298316.0, 'lo_frequency': 7370000000.0, 'correction': [1, 0.0, 0.0, 1]}],
    },
}
