...
# Single QUA script generated at 2025-04-10 05:37:00.301551
...
with program() as prog:
    ...
    with for_(v1,0,(v1<5000),(v1+1)):
        align()
        play("2153572541971945415", "B2/drive")
        wait(11, "B2/acquisition")
        measure("6473651740920266459", "B2/acquisition", None, dual_demod.full("cos", "sin", v2), dual_demod.full("minus_sin", "cos", v3))
        r1 = declare_stream()
        save(v2, r1)
        r2 = declare_stream()
        save(v3, r2)
    ...
    with stream_processing():
        r1.buffer(5000).save("6473651740920266459_B2|acquisition_I")
        r2.buffer(5000).save("6473651740920266459_B2|acquisition_Q")
...
config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "intermediate_frequency": 9540944.0,
            "time_of_flight": 224.0,
            "smearing": 0.0,
            "operations": {
                "6473651740920266459": "6473651740920266459_B2/acquisition",
            },
        },
        "B2/drive": {
            "RF_inputs": {
            ...
            "operations": {
                "2153572541971945415": "2153572541971945415",
            },
        },
    },
    "pulses": {
        "-5014484193394297398_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "5892296211531419190_i",
                "Q": "5892296211531419190_q",
            },
            "digital_marker": "ON",
        ...
        "2153572541971945415": {
            "length": 40,
            "waveforms": {
                "I": "2153572541971945415_i",
                "Q": "2153572541971945415_q",
            },
            "digital_marker": "ON",
            "operation": "control",
        },
        "6473651740920266459_B2/acquisition": {
            "length": 2000.0,
            "waveforms": {
                "I": "-7789641754949809804_i",
                "Q": "-7789641754949809804_q",
            },
            "digital_marker": "ON",
            "operation": "measurement",
            "integration_weights": {
    ...
    "waveforms": {
        "5892296211531419190_i": {
            "sample": 0.0021,
            "type": "constant",
        },
        "5892296211531419190_q": {
            "sample": 0.0,
            "type": "constant",
        },
        "2153572541971945415_i": {
        ...
        "-7789641754949809804_i": {
            "sample": 0.00175,
            "type": "constant",
        },
        "-7789641754949809804_q": {
            "sample": 0.0,
            "type": "constant",
        },
    },
...
loaded_config = {
    ...
    "elements": {
        ...
        "B2/acquisition": {
            ...
            "mixInputs": {
                "I": ('con2', 1, 1),
                "Q": ('con2', 1, 2),
                "mixer": "B2/acquisition_mixer_1c9",
                "lo_frequency": 7370000000.0,
            },
            "smearing": 0,
            "time_of_flight": 224,
    ...
    "mixers": {
        "B2/acquisition_mixer_1c9": [{'intermediate_frequency': 9540944.0, 'lo_frequency': 7370000000.0, 'correction': (1, 0, 0, 1)}],
        "B2/drive_mixer_c6d": [{'intermediate_frequency': 63761228.0, 'lo_frequency': 5900000000.0, 'correction': (1, 0, 0, 1)}],
    },
}
